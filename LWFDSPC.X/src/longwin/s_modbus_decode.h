...
//   目前 V0.20 -> Category=0, Major=2, Minor=0 -> 0x0020 (GUI 顯示 V0.20)
//   ※ 每次出版時更新此三個數字,並在 git 打對應 tag (ex: v0.20)。
//=================================================================================================
#define FW_VER_CATEGORY 0   // 類別號 (00~99) -> 高位元組
#define FW_VER_MAJOR    2   // 主版號 (0~9)   -> D7-D4
#define FW_VER_MINOR    0   // 次版號 (0~9)   -> D3-D0
