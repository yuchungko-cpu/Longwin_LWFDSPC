...
// --- 正轉油門電壓與輸出對應關係 ---
#define LOGIC_THROTTLE_FWD_VOLTAGE_MIN_MV (500u)  // 正轉油門有效起始電壓 (對應輸出 MIN)
...
// --- 反轉油門電壓與輸出對應關係 ---
#define LOGIC_THROTTLE_REV_VOLTAGE_MIN_MV (500u)  // 反轉油門有效起始電壓 (對應輸出 MIN)
...
// Format: {Step, TimeMs}
#define THROTTLE_FWD_ACCEL_STEP_TIME_ENTRY_0 {2, 2}  // <= LOGIC_THROTTLE_FWD_ACCEL_V1_MV (1700mV)
#define THROTTLE_FWD_ACCEL_STEP_TIME_ENTRY_1 {3, 3}  // <= LOGIC_THROTTLE_FWD_ACCEL_V2_MV (2200mV)
...
// Format: {Step, TimeMs}
#define THROTTLE_FWD_DECEL_STEP_TIME_ENTRY_0 {-9, 1}  // <= LOGIC_THROTTLE_FWD_DECEL_O1 (4800)
#define THROTTLE_FWD_DECEL_STEP_TIME_ENTRY_1 {-14, 1}  // <= LOGIC_THROTTLE_FWD_DECEL_O2 (7600)
#define THROTTLE_FWD_DECEL_STEP_TIME_ENTRY_2 {-19, 1}  // <= LOGIC_THROTTLE_FWD_DECEL_O3 (10400)
#define THROTTLE_FWD_DECEL_STEP_TIME_ENTRY_3 {-24, 1}  // <= LOGIC_THROTTLE_FWD_DECEL_O4 (13200)
#define THROTTLE_FWD_DECEL_STEP_TIME_ENTRY_4 {-29, 1}  // > LOGIC_THROTTLE_FWD_DECEL_O4 (13200)
...
// Format: {Step, TimeMs}
#define THROTTLE_REV_DECEL_STEP_TIME_ENTRY_0 {-7, 1}  // <= LOGIC_THROTTLE_REV_DECEL_O1 (4800)
#define THROTTLE_REV_DECEL_STEP_TIME_ENTRY_1 {-10, 1}  // <= LOGIC_THROTTLE_REV_DECEL_O2 (7600)
#define THROTTLE_REV_DECEL_STEP_TIME_ENTRY_2 {-13, 1}  // <= LOGIC_THROTTLE_REV_DECEL_O3 (10400)
#define THROTTLE_REV_DECEL_STEP_TIME_ENTRY_3 {-16, 1}  // <= LOGIC_THROTTLE_REV_DECEL_O4 (13200)
#define THROTTLE_REV_DECEL_STEP_TIME_ENTRY_4 {-19, 1}  // > LOGIC_THROTTLE_REV_DECEL_O4 (13200)
                                                      //
// 初始化定義最高轉速
